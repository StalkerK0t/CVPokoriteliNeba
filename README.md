...
На обучение было отведено 10 эпох. Результаты для каждой буквы в алфавитном порядке получились следующие:
...
В общем случае точность распознавания составила более 90% процентов, за исключением букв 23 и 28, которые при повороте на 180° превращаются друг в друга. Таким образом, нейросеть может уверенно распознавать большинство букв армянского алфавита в не зависимости от их ориентации, а также при искажениях дающих соотношение сторон до 1:2.
